<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_feed|template/default/header|template/default/space_status|template/default/space_menu|template/default/space_feed_li|template/default/space_feed_li|template/default/space_feed_li|template/default/footer', '1266509374', 'template/default/space_feed');?><?php if(empty($_TPL['getmore'])) { ?>	
...
<ul class="u_setting">
<li class="dropmenu" id="usettingli" onmouseover="showMenu(this.id)"><a href="cp.php">个人设置 <img src="image/more.gif" align="absmiddle"></a></li>
</ul>
