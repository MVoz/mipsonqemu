<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/bookmark|template/default/bm_header|template/default/footer', '1266310900', 'template/default/bookmark');?><?php $_TPL['nosidebar']=1; ?>
...
<form name="loginform" action="do.php?ac=<?=$_SCONFIG['login_action']?>&<?=$url_plus?>&ref" method="post">
<div class="logined">
<h3>您好！<a href="http://192.168.115.2/uc/home/link.php?url=http://www.goalhi.com" target=_blank><span>admin</span></a>，欢迎您回来！</h3>
...
<span class=deletebtn><a href="http://192.168.115.2/uc/home/space.php?uid=1">删除</a></span>
</li>
<?php } } ?>
</ul>
...
<li><a href="space.php?do=notice"><span>Opera</span></a></li>
                    ...
                    <div class="nbox_s side_rbox side_rbox_w" style="margin-top:10px;">
                        <h2 class=ntitle_1>
                        </h2>
                        <div class=side_rbox_c>
<a title=admin href="http://192.168.115.2/uc/home/space.php?uid=1" target=_blank>
...
alert(id);
//	ajaxget('space.php?uid=<?=$space['uid']?>&do=bookmark&groupid=8001&ajaxdiv=bmcontent', 'bmcontent');
ajaxget('space.php?uid=<?=$space['uid']?>&do=bookmark&groupid=8001&ajaxdiv=bmcontent', 'bmcontent');
}
</script><?php ob_out();?>