<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_invite|template/default/header|template/default/footer', '1266338066', 'template/default/cp_invite');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
