<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_theme|template/default/header|template/default/cp_header|template/default/cp_header|template/default/footer', '1266338039', 'template/default/cp_theme');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
