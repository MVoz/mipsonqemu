            ...
            <div class="con">
            	<form action="<{$sys.subform}>" method="post">
                  <div class="table">
                  	<div class="th">
                    	<div class="form">
                    	  <input type="button" value="添加名站" onClick="location.href='?c=collect_site&a=collect_site_add'" />&nbsp;
			</div>
			</div>
...
<{foreach from=$data item=v key=k}>
                    ...
                    <td><a href="?c=collect_site&a=collect_site_save&id=<{$v.id}>"><span style="color:<{$v.namecolor}>"><{$v.name}></span></a></td>
