        ...
        <div id="main">
            ...
            <div class="con">
            	<form action="?c=url_add&a=delete" method="post">
                  ...
                  <div class="table">
                  	<div class="th">
                    &nbsp;&nbsp;<a href="?c=site_report">查看全部</a>&nbsp;
                    &nbsp;&nbsp;<a href="?c=site_report&type=0">未处理</a>&nbsp;
                    &nbsp;&nbsp;<a href="?c=site_report&type=1">已处理</a>&nbsp;
                    </div>
			...
			<th>提交者</th> 
                    ...
                    <tr>
                        <td><input type="checkbox" name="delete[<{$i.siteerrid}>]/>"/></td>
                        <td><{$i.name}></td>
                        <td><{$i.url}></td>
			<td><{$i.errid}></td>
                        <td><{if $i.type eq 1}>通过<{elseif $i.type eq 2}>拒绝<{else}>未审核<{/if}></td>                        
                        <td><a href="?c=site_report&a=show&id=<{$i.id}>">修改</a></td>
                    </tr>
                    <{/foreach}>
                    <tr class="foot-ctrl">
