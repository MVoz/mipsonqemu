    ...
    <div class="container">
        ...
        <div id="main">
            ...
            <div class="con box-green">
                <form action="?c=famous_class&a=add" method='post'>
...
<div class="wrap">
    <div class="container">
        ...
        <div id="main">
            ...
            <div class="con box-green">
                <form action="?c=famous_class&a=edit" method='post'>
...
<div class="wrap">
    <div class="container">
        ...
        <div id="main">
            ...
            <div class="con">
            	<form action='?c=famous_class&a=index' method='post'>
                  <div class="table">
                  	<div class="th">
                    	<div class="form">
                        <div class="fl">
                           <input type="button" onclick="window.location='?c=famous_class&a=add'" value="添加分类" />
                              &nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                        </div>
                    </div>
                    ...
                    <td><a href="?c=famous_site&classid=<{$class.classid}>"><{$class.classname}></a></td>
                    <td><input name="path[<{$class.classid}>]" type="text" class="textinput" style="width: 200px;" id="path[<{$class.classid}>]" value="<{$class.path}>" /></td>
                    <td><{$class.sitenum}></td>
                    <td>[<a href="?c=famous_class&a=edit&id=<{$class.classid}>">修改</a>] </td>
                    </tr>
                    <{/foreach}>
                    <{else}>
                    <tr>
