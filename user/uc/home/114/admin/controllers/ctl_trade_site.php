 ...
 * @version    $Id: ctl_trade_site.php 1541 2009-12-11 07:54:41Z syh $
 */
...
class ctl_trade_site
{
    ...
    public static function index()
    {
        try
        {
            app_tpl::assign( 'npa', array('专题管理', '行业站点列表') );
            $show_type = 'default';
            // 按分类查看
        ...
        try
        {
            ...
            if ($action == 'add')
            {
                if (app_db::insert('ylmf_tradesite', array_keys($data), array_values($data)))
                {
                    ...
                    mod_login::message('添加成功', '?c=trade_site&classid=' . $class_id);
                }
                else
                {
            ...
            elseif ($action == 'modify')
            {
                ...
                else
                {
                    ...
                    mod_login::message('修改成功', '?c=trade_site&classid=' . $class_id);
                }
            }
        }
        catch (Exception $e)
    ...
    public static function edit()
    {
        try
        {
            ...
            if ($action == 'modify')
            {
                app_tpl::assign( 'npa', array('专题管理', '编辑行业站点') );
            ...
            {
                app_tpl::assign( 'npa', array('专题管理', '新增行业站点') );
