...
**
** Created: Wed Oct 28 17:42:21 2009
...
public:
    ...
    aboutVer_2 = new QLabel(tab_3);
    aboutVer_2->setObjectName(QString::fromUtf8("aboutVer_2"));
    QFont font;
    font.setPointSize(10);
    font.setBold(true);
    font.setWeight(75);
    aboutVer_2->setFont(font);
    aboutVer_2->setWordWrap(false);

    vboxLayout20->addWidget(aboutVer_2);

    spacerItem21 = new QSpacerItem(611, 121, QSizePolicy::Minimum, QSizePolicy::Expanding);
    ...
    spacerItem24 = new QSpacerItem(61, 98, QSizePolicy::Expanding, QSizePolicy::Minimum);

    hboxLayout16->addItem(spacerItem24);

    aboutText = new QLabel(tab_3);
    ...
    hboxLayout16->addWidget(aboutText);

    spacerItem25 = new QSpacerItem(51, 98, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    spacerItem26 = new QSpacerItem(111, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

    hboxLayout17->addItem(spacerItem26);
    ...
    hboxLayout17->addWidget(label_2);

    spacerItem27 = new QSpacerItem(121, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

    hboxLayout17->addItem(spacerItem27);


    vboxLayout20->addLayout(hboxLayout17);

    spacerItem28 = new QSpacerItem(636, 141, QSizePolicy::Minimum, QSizePolicy::Expanding);

    vboxLayout20->addItem(spacerItem28);
    ...
    hboxLayout18->addItem(spacerItem29);
    ...
    hboxLayout18->addWidget(buttonBox);


    vboxLayout->addLayout(hboxLayout18);
    ...
    aboutVer_2->setText(QString());
    aboutVer->setText(QString());
    aboutText->setText(QApplication::translate("OptionsDlg", "<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
