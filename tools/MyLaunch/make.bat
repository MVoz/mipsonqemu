...
cd /d dll
for %%i in (bmapi testserver catalog xmlreader updaterThread posthttp mergethread Bookmark_sync synchronizeDlg options icon_delegate catalog_types) do call :makefunc %%i 
cd ..
