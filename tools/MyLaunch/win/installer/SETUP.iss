...
[Setup]
AppMutex=TanzhiMutex,Global\TanzhiMutex
AppName={#MyAppName}
...
SetupIconFile=..\Tanzhi.ico
Compression=lzma
SolidCompression=true
ShowLanguageDialog=yes
AppID=Tanzhi_21344213
...
[Files]
Source: ..\..\release\Tanzhi.exe; DestDir: {app}; Flags: ignoreversion
Source: ..\..\release\Tanzhi.exe; DestDir: {app}; Flags: ignoreversion
...
; Documentation
Source: ..\Tanzhi.ico; DestDir: {app}; Flags: ignoreversion
...
Name: {group}\Tanzhi Rescue Mode; Filename: {app}\{#MyAppExeName}; WorkingDir: {app}; Parameters: rescue
