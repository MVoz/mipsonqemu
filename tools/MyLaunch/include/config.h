...
enum{
	...
	SYNC_STATUS_PROCESSING_3,
	SYNC_STATUS_PROCESSING_4,
	SYNC_STATUS_PROCESSING_5,
	SYNC_STATUS_PROCESSING_6,
	SYNC_STATUS_PROCESSING_7,
	SYNC_STATUS_PROCESSING_8,
	SYNC_STATUS_PROCESSING_MAX
};
#define CONFIG_SYNC_STATUS_DEBUG
/*
enum {
	SYNC_STATUS_FAIL=0,
	SYNC_STATUS_PROCESSING,
