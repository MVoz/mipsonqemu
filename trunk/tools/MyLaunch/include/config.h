...
#define COME_FROM_MYBOOKMARK 5

#define COMF_FROM_NETBOOKMARK 6
#define COME_FROM_IE (COMF_FROM_NETBOOKMARK+1)
#define COME_FROM_FIREFOX	 (COMF_FROM_NETBOOKMARK+2)
#define COME_FROM_OPERA	 (COMF_FROM_NETBOOKMARK+3)
#define COME_FROM_MAX	(COMF_FROM_NETBOOKMARK+4)



#define COME_FROM_BROWSER_START COMF_FROM_NETBOOKMARK
#define COME_FROM_BROWSER_END (COME_FROM_MAX-1)

#define COME_FROM_BROWSER COME_FROM_BROWSER_START

#define IS_FROM_BROWSER(x) (((x)>=COMF_FROM_NETBOOKMARK)&&((x)<COME_FROM_MAX))

#define BROWSE_TYPE_NETBOOKMARK		(COMF_FROM_NETBOOKMARK-COMF_FROM_NETBOOKMARK)
#define BROWSE_TYPE_IE 		(COME_FROM_IE-COMF_FROM_NETBOOKMARK)
#define BROWSE_TYPE_FIREFOX 	(COME_FROM_FIREFOX-COMF_FROM_NETBOOKMARK)
#define BROWSE_TYPE_OPERA		(COME_FROM_OPERA-COMF_FROM_NETBOOKMARK)
#define BROWSE_TYPE_MAX 		(COME_FROM_MAX-COMF_FROM_NETBOOKMARK)
