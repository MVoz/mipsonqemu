<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_avatar|template/default/header|template/default/cp_header|template/default/footer', '1266338061', 'template/default/cp_avatar');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
