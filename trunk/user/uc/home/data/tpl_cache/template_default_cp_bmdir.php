<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_bmdir|template/default/header|template/default/footer', '1266420713', 'template/default/cp_bmdir');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
...
<iframe style="position:absolute;z-index:-1;width:expression(this.previousSibling.offsetWidth);height:expression(this.previousSibling.offsetHeight);top:expression(this.previousSibling.offsetTop);left:expression(this.previousSibling.offsetLeft);background-color:#FCF9E6;"   frameborder="0"></iframe>
...
<div class="popupmenu_inner">
<?php if($_GET['op'] == 'edit') { ?>
<form method="post" action="cp.php?ac=bmdir&op=edit&bmdirid=<?=$bmdirid?>">
<?php } else { ?>
<form method="post" action="cp.php?ac=bmdir&op=add&bmdirid=<?=$bmdirid?>">
<?php } ?>
...
<td>	
<?php if($_GET['op'] == 'edit') { ?>
<input type="text" id="subject" name="subject" value="<?=$bmdirname?>" style="width: 396px;" class="t_input" tabindex="1"  />
<?php } else { ?>
<input type="text" id="subject" name="subject" value="" style="width: 396px;" class="t_input" tabindex="1"  />
<?php } ?>
</td>
</tr>
<?php if($_GET['op'] == 'add') { ?>
...
<td>
<select id="category" name="category" onchange="categoryShow(this.value);"/>
...
<td>
<input type="text" id="address" name="address" value="" style="width: 396px;" class="t_input" tabindex="1"  />
</td>
</tr>
<tr>
<th><label for="tag">标签：</label></th>
<td>
<input type="text" id="tag" name="tag" value="" style="width: 396px;" class="t_input" tabindex="1"  />
</td>
</tr>
</tbody>
<?php } ?>
...
<td><textarea id="description" name="description" cols="40" rows="4" style="width: 400px; height: 150px;" onkeydown="ctrlEnter(event, 'pmsubmit_btn');"></textarea></td>
</tr>
<tr>
<th>&nbsp;</th>
<td>
