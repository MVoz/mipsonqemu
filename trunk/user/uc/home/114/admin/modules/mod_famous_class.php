 ...
 * @version    $Id: mod_cool_class.php 1541 2009-12-11 07:54:41Z syh $
 */
!defined('PATH_ADMIN') &&exit('Forbidden');
class mod_famous_class
{
    /**
     * 获取酷站分类列表
     *
    ...
    public static function edit_class($data)
    {
        ...
        if( $data['classnewname']=='' )
        {
            mod_login::message("请输入新分类名称!",'?c=famous_class&a=index');
        }
        else
        {
            if($path!='')
        ...
        mod_login::message("修改成功!",'?c=famous_class&a=index');
    }
