...
<div class="wrap">
    <div class="container">
        ...
        <div id="main">
            ...
            <div class="con">
            	<form action="?c=famous_site&a=search" method="get">
                    <input type="hidden" name="c" value="famous_site"/>
            	...
            	<form action="?c=famous_site&a=list_edit" method="post">
                    <input type="hidden" name="referer" value="<{$referer}>"/>
                  <div class="table">
                  	<div class="th">
                    	<div class="form fl">
                        <input type="button" value="添加名站" onclick="window.location='?c=famous_site&a=edit&action=add&classid=<{$class_id}>'"/>&nbsp;
                        <label for="alltopic">按分类查看</label>&nbsp;
                        <select id="alltopic" onchange=window.location='?c=famous_site&classid='+this.value>
                        ...
                        &nbsp;&nbsp;<a href="?c=famous_class&a=index" style="color:white"><b>查看所有名站分类</b></a>&nbsp;
                        &nbsp;&nbsp;<a href="?c=famous_site&isend=1">查看过期站点</a>&nbsp;
                    </div>
                    ...
                    <tr>
                        ...
                        *}>
                        ...
                        <td><a href="?c=famous_site&a=edit&action=modify&id=<{$i.id}>"><{$i.name}></a></td>
                        <td><div style="width:180px;" class="hideText" title="<{$i.url}>"><{$i.url}></div></td>
                        <td><a href="?c=famous_site&classid=<{$i.classid}>"><{$i.classname}></a></td>
