...
<title><{$title}></title>
<link href="<{$URL}>/custom/default/page.css" rel="stylesheet" type="text/css" />
<link id="skin" href="<{$URL}>/themes/custom/skins/blue/page.css" rel="stylesheet" type="text/css" />
