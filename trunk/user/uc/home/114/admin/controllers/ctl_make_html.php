 ...
 * @version    $Id: ctl_make_html.php 1541 2009-12-11 07:54:41Z syh $
 */
	...
	public static function set()
	{
	    try
	    {
	        ...
	        else
	        {
                ...
                $tmp = app_db::select('ylmf_siteconfig', '*', 'yl_name="' . $config_key . '"');
                if (empty($tmp))
                {
                    app_db::insert('ylmf_siteconfig', array('yl_name', 'yl_value'), array($config_key, $real_time));
                }
                else
                {
                    app_db::update('ylmf_siteconfig', array('yl_value' => $real_time), "yl_name = '{$config_key}'");
                }
