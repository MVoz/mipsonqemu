    ...
    public function start()
    {
        ...
        if( file_exists($cacheFiles) )
        {
            ...
            if( $curfile != '' )
            {
                ...
                $downfile_url = mod_update::$source_url .'/'. mod_update::$current_version. '_utf8' . '/source/'.$curfile;
            ...
            else
            {
                ...
                foreach($sqls as $sql)
                {
                    $downfile_url = mod_update::$source_url .'/'. mod_update::$current_version. '_utf8' . '/'.$sql.".txt";
