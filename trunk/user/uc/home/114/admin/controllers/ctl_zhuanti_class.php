...
class ctl_zhuanti_class
{
    ...
    public static function index()
    {
        try
        {
            ...
            $result = mod_zhuanti_class::get_list($type);
    ...
    public static function save()
    {
        try
        {
            ...
            require PATH_DATA . '/conf/zhuantidb.php';
            if (empty($type) || !array_key_exists($type, $zhuantidb))
            {
            ...
            if ($action == 'add')
            {
                ...
                else
                {
                    ...
                    mod_login::message('添加成功', '?c=zhuanti_class&type=' . $type);
                }
            ...
            elseif ($action == 'modify')
            {
                ...
                else
                {
                    ...
                    mod_login::message('修改成功', '?c=zhuanti_class&type=' . $type);
                }
            }
        }
        catch (Exception $e)
