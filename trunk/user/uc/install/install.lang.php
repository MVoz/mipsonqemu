...
$lang = array(
	...
	'all_install' => '您已经成功安装过程序,请先删除 install 目录下的 install.lock文件， 然后再次运行安装文件',
	'discuz_install' => '您已经成功安装过论坛，如果想要重新安装，请删除 ./bbs/forumdata/install.lock 文件，然后刷新重试',
	'ucenter_install' =>'已经安装过UCenter，如果您想重新安装UCenter，请删除 ./ucenter/data/install.lock 文件，再次运行安装文件',
	'ucenterhome_install' => '已经安装过UCenter Home!，如果您想重新安装UCenter Home，请删除 ./home/data/install.lock 文件，再次运行安装文件',
	...
	'uchome_bbs_admin' => 'UCenter Home和Discuz!管理员信息',
	...
	'none' => '无',
	'save_setup_info' => '以下为UCenter 1.5.0,UCenter Home 2.0,Discuz! 7.0.0安装信息,请妥善保存,为了您的数据安全请尽快删除./install目录',
	'copy' => '复制',
	'go_home' =>'完成',
	'setup' => '安装'
);
